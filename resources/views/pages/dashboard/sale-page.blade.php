    ...
    <script>
        ...
        async function CustomerList() {
            ...
            res.data.forEach(function (item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-name=" ${item['name']}" data-email=" ${item['email']}" data-id=" ${item['id']}" class="btn btn-outline-dark addCustomer text-xxs btn-sm  px-2 py-1 m-0">Add</a></td>
                     </tr>`
        ...
        function add() {
            ...
            if (PId.length === 0) {
                ...
                let item = {product_name: PName, product_id: PId, quantity: PQty, sale_price: PTotalPrice};
